...
- **Task 2**: Modify the example code to send a simple "Hello from M5StickC [Student ID]" message from each device, where [StudentID] is your student ID to uniquely identify each M5StickC in the network.
